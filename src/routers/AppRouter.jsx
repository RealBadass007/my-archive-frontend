...
import { Home, Error, ViewGameAll, ViewGameDetails, ViewStoreAll, ViewStoreDetails, ViewCreatorAll, ViewMyPortfolio } from '../views/index';
    ...
    <BrowserRouter>
      <Routes>
        <Route path = "/" element = { <BaseLayout /> }>
          ...
          <Route path = "/portfolio" element = { <ViewMyPortfolio />} />
